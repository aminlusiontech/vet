...
const ProfileOverview = () => {
  ...
  useEffect(() => {
    // Only show errors that are not authentication-related when user is already authenticated
    // This prevents showing "Please login to continue" when user is already logged in
    if (error) {
      // Don't show authentication errors if user is already authenticated
