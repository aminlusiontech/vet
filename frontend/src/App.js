...
const routes = (
  <Routes>
    ...
    >
      ...
      <Route path="seller-orders" element={<Navigate to="/profile/orders?view=selling" replace />} />
      <Route path="review-orders" element={<Navigate to="/profile/orders?view=selling" replace />} />
      ...
      <Route path="seller-refunds" element={<Navigate to="/profile/disputes-refunds?tab=review-refunds" replace />} />
      <Route path="refunds" element={<Navigate to="/profile/disputes-refunds?tab=my-refunds" replace />} />
      <Route path="shop-settings" element={<ProfileShopSettings />} />
      <Route path="bundles" element={<ProfileBundles />} />
      <Route path="seller-offers" element={<Navigate to="/profile/offers?view=selling" replace />} />
      <Route path="seller-order/:id" element={<ProfileSellerOrderDetails />} />
    ...
    <Route
      ...
      element={
        <SellerProtectedRoute>
          <Navigate to="/profile/disputes-refunds?tab=review-refunds" replace />
        </SellerProtectedRoute>
      }
    />
    <Route
