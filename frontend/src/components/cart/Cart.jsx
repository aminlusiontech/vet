...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10" id="side-cart">
        ...
        {cart && cart.length == 0 ? (
          ...
          <>
            ...
            <div className="px-5 mb-3">
              ...
              <Link to="/checkout">
                <div
                  className={`h-[45px] flex items-center justify-center w-[100%] bg-[#38513b] rounded-[5px]`}
                >
    ...
    <>
      <div className="border-b p-4">
        <div className="w-full flex items-center">
          <div>
            <div
              className={`bg-[#38513b] border border-[#38513b73] rounded-full w-[25px] h-[25px] ${styles.noramlFlex} justify-center cursor-pointer`}
          ...
          <div className="pl-[15px]">
            ...
            <h4 className="font-[400] text-[17px] pt-[3px]  text-[#38513b] font-Poppins ">
          ...
          <RxCross1
            size={30}
            color="#000"
            className="cursor-pointer cart-rem-prod"
